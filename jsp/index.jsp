...
<%!
    ...
    public static String renderFileManagerContent() {
        ...
        html.append("            console.log('loadFiles: path parameter provided:', path, '-> normalized:', currentPath);\n");
        html.append("        } else {\n");
        html.append("            const inputPath = document.getElementById('currentPath').value;\n");
        html.append("            currentPath = normalizePath(inputPath);\n");
        html.append("            console.log('loadFiles: from input:', inputPath, '-> normalized:', currentPath);\n");
        html.append("        }\n");
        html.append("        \n");
        html.append("        const url = '?action=list_files&path=' + encodeURIComponent(currentPath);\n");
        html.append("        console.log('loadFiles: fetching:', url);\n");
        html.append("        \n");
        html.append("        fetch(url)\n");
        html.append("            .then(r => {\n");
        html.append("                console.log('loadFiles: response status:', r.status);\n");
        html.append("                if (!r.ok) throw new Error('HTTP ' + r.status);\n");
        html.append("                return r.json();\n");
        html.append("            })\n");
        html.append("            .then(data => {\n");
        html.append("                console.log('loadFiles: data received:', data);\n");
        ...
        html.append("        \n");
        html.append("        console.log('renderFiles: rendering', files.length, 'items');\n");
        html.append("        \n");
        ...
        html.append("            const fullPath = normalizePath(currentPath + separator + f.name);\n");
        html.append("            console.log('renderFiles: item path:', fullPath);\n");
        html.append("            \n");
        html.append("            const onclick = f.isDir ? 'loadFiles(\\\\'' + escapeAttr(fullPath) + '\\\\')' : 'editFile(\\\\'' + escapeAttr(fullPath) + '\\\\')';\n");
        html.append("            \n");
        html.append("            tr.innerHTML = '<td style=\\\"cursor:pointer;\\\" onclick=\\\"' + onclick + '\\\">' + icon + ' ' + escapeHtml(f.name) + '</td>' +\\n");
        ...
        html.append("        showToast('Error rendering files: ' + err.message, 'error');\n");
        html.append("    }\n");
        html.append("}\n");
        html.append("\n");
        html.append("function goUp() {\n");
        html.append("    try {\n");
        html.append("        console.log('goUp: current path:', currentPath);\n");
        html.append("        const normalized = normalizePath(currentPath);\n");
        html.append("        console.log('goUp: normalized:', normalized);\n");
        html.append("        \n");
        html.append("        if (normalized === '/' || normalized === '') {\n");
        html.append("            console.log('goUp: already at root');\n");
        ...
        html.append("        console.log('goUp: parent path:', parentPath);\n");
        html.append("        \n");
        ...
        html.append("    console.log('editFile: path:', path);\n");
        ...
        html.append("    \n");
        html.append("    console.log('saveFile: path:', editingFile);\n");
        ...
        html.append("        console.log('showNewFolder: path:', newPath);\n");
        ...
        html.append("        console.log('renameItem: old:', oldPath, 'new:', newPath);\n");
        ...
        html.append("        console.log('deleteItem: path:', deletePath);\n");
